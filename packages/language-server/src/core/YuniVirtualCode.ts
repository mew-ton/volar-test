import { type Stack, type Mapping, type ExtraServiceScript, forEachEmbeddedCode } from '@volar/language-core'
import type { CodeMapping, LanguagePlugin, VirtualCode } from '@volar/language-server/node.js'
